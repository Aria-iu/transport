...
def batch_process_images(image_dir, output_dir_1024, output_dir_512, csv_dir_1024, csv_dir_512):
    ...
    generate_patches(image_paths, output_dir_1024, patch_size=(1024, 1024), output_csv_dir=csv_dir_1024)
    generate_patches(image_paths, output_dir_512, patch_size=(512, 512), output_csv_dir=csv_dir_512)
...
if __name__ == "__main__":
    ...
    for sample in os.listdir(images):
        ...
        print(output_dir_1024)
        print(output_dir_512)
        print(csv_dir_1024)
        print(csv_dir_512)
        ...
        batch_process_images(img+'.jpg', output_dir_1024, output_dir_512, csv_dir_1024, csv_dir_512)
